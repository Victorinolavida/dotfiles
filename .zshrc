...
#
# alias ls="eza --color --icons --tree --level=1 --group-directories-first --all"
alias ls="eza --color --icons --tree --level=1 --group-directories-first"
# alias ls="eza --color --icons --tree --group-directories-first --all --level=0 "
alias vim="nvim"
...
source /Users/victorinolavida/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

alias air='$(go env GOPATH)/bin/air'

[ -f "/Users/victorinolavida/.ghcup/env" ] && . "/Users/victorinolavida/.ghcup/env" # ghcup-env

# fnm
FNM_PATH="/Users/victorinolavida/Library/Application Support/fnm"
if [ -d "$FNM_PATH" ]; then
  export PATH="/Users/victorinolavida/Library/Application Support/fnm:$PATH"
  eval "`fnm env`"
fi
